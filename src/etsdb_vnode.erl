...
init([Index]) ->
    ...
    DataDir = etsdb_leveldb_affinity:get_path(Index),
    {BackEndModule,BackEndProps0} = app_helper:get_env(etsdb, backend,{etsdb_leveldb_backend,[]}),
    BackEndProps = [{data_root, DataDir}|BackEndProps0], %% Use calculated data dir
