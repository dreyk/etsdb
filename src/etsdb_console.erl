%% -------------------------------------------------------------------
%%
%% etsdb_console: interface for Etsdb admin commands.
%% This code base on original code of riak_kv_console. See http://github.com/basho/riak_kv
%%
...
%% @doc interface for Etsdb admin commands
